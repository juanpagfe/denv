...
if xrandr --query | grep -qE "HDMI.* connected"; then
    xrandr --output eDP-1 --mode 3072x1920 --scale 0.7x0.7 --pos 1920x0 --rotate normal
    xrandr --output HDMI-1 --primary --mode 1920x1080 --scale 1x1 --pos 0x0 --rotate normal
    ...
    xrandr --output eDP-1 --mode 3072x1920 --scale 0.7x0.7 --pos 0x0 --rotate normal --output HDMI-1 --off
    declare -A screen_workspaces=()
    declare -A workspace_apps=(
        ["1"]="ghostty"
        ["2"]="google-chrome"
